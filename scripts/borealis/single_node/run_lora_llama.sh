...
accelerate launch --config_file=${trl_repo_path}/trl/examples/accelerate_configs/fsdp2_lora.yaml \
	-m trl.scripts.sft \
	...
	--use_peft \
	--lora_r 32 \
	--lora_alpha 16 2>&1 | tee ${output_dir}/${WW}/${model_config}/single_node/lora.log
